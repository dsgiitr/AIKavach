...
from extra.utils_model import test_mode
from extra.utils_regularizers import regularizer_orth, regularizer_clip
...
class ModelPlain(ModelBase):
    ...
    def load(self,pt=None):
        ...
        if self.opt_train['E_decay'] > 0:
            ...
            self.netE.eval()
        if pt is not None:
            print('Loading model for G [{:s}] ...'.format(pt))
            self.load_network(pt, self.netG, strict=self.opt_train['G_param_strict'], param_key='params')
